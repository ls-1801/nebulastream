...
/// The ExecutablePipelineStage is the legacy interface that describes a processing step within a stream processing query.
///
/// This interface uses TupleBuffer and PipelineExecutionContext directly. New code should implement
/// adaptive_engine::PipelineStage instead, which uses BufferHandle and adaptive_engine::ExecutionContext.
///
/// TODO(US-033): Migrate all implementations to adaptive_engine::PipelineStage and remove this interface.
