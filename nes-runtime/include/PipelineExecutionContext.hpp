...
namespace NES
{
/// Interface for pipeline execution context used by the internal NES ExecutionContext.
///
/// This class provides the execution environment for a pipeline stage, including
/// buffer management, worker identification, and operator handler access.
